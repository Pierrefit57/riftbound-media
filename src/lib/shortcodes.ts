...
export function parseShortcodes(text: string): string {
  ...
  processed = processed.replace(/\[youtube:([^\]]+)\]/g, (match, input) => {
    ...
    return `<div class="youtube-embed"><div class="youtube-facade" data-video-id="${videoId}" onclick="this.innerHTML='<iframe src=&quot;${embedUrl}&quot; frameborder=&quot;0&quot; allow=&quot;accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture&quot; allowfullscreen style=&quot;position:absolute;top:0;left:0;width:100%;height:100%;border:none;border-radius:0.75rem;&quot;></iframe>';this.style.cursor='default'"><img src="${thumbUrl}" alt="YouTube Video" loading="lazy" style="width:100%;height:100%;object-fit:cover;position:absolute;top:0;left:0;border-radius:0.75rem;"/><div class="youtube-play-btn"><svg viewBox="0 0 68 48" width="68" height="48"><path d="M66.52 7.74c-.78-2.93-2.49-5.41-5.42-6.19C55.79.13 34 0 34 0S12.21.13 6.9 1.55c-2.93.78-4.64 3.26-5.42 6.19C.06 13.05 0 24 0 24s.06 10.95 1.48 16.26c.78 2.93 2.49 5.41 5.42 6.19C12.21 47.87 34 48 34 48s21.79-.13 27.1-1.55c2.93-.78 4.64-3.26 5.42-6.19C67.94 34.95 68 24 68 24s-.06-10.95-1.48-16.26z" fill="red"/><path d="M45 24L27 14v20" fill="white"/></svg></div></div></div>`;
  });
