...
async function finalTest() {
    console.log(`Starting final verification for ${toEmail}...`);
    ...
    console.log(`Found User: ${user.email}, Username: ${username}`);
    ...
    console.log(`Formatted Date (Paris): ${formattedDate}`);
        ...
        <tr>
          <td align="center" style="padding: 40px 0;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="container">
              ...
              <tr>
                <td class="footer">
                  <p style="font-size: 12px; color: #627d98; margin: 0 0 10px 0;">Test Final - Dynamique & Timezone Paris.</p>
    ...
    try {
        const { data, error } = await resend.emails.send({
            ...
            to: toEmail,
            subject: `🔔 TEST FINAL : ${event.title}`,
            html: html,
        });
