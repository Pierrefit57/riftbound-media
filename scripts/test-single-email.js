...
// Test recipients
const recipients = ['zawodny.pierre@gmail.com'];

const event = {
    title: "Tirage Sorcier Mystique Riot Merch Officielle",
    start_date: "2026-02-17T18:18:32.448599+00:00",
    location: "En ligne",
    type: "social"
};
...
async function testEmail() {
        ...
        <tr>
          <td align="center" style="padding: 40px 0;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="container">
              ...
              <tr>
                <td class="content">
                  <h2 style="font-size: 24px; margin-top: 0; color: #ffffff;">Bonjour Pierre,</h2>
                  ...
                  <div class="event-box">
                    ...
                    <h3 style="font-size: 20px; color: #ffffff; margin: 0 0 15px 0;">${event.title}</h3>
              ...
              <tr>
                <td class="footer">
                  <p style="font-size: 12px; color: #627d98; margin: 0 0 10px 0;">Test Design V3 - Envoyé via notifications@riftbound-media.fr</p>
    ...
    for (const to of recipients) {
        ...
        try {
            ...
            if (error) {
                console.error(`Error for ${to}:`, JSON.stringify(error, null, 2));
            } else {
                console.log(`Success for ${to}! ID: ${data?.id}`);
            }
        } catch (err) {
            console.error(`Exception for ${to}:`, err);
        }
    }
}
